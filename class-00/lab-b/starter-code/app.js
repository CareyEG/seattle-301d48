...
const sumAndProduct = (a, b) => `${a} + ${b} = ${a + b}, ${a} * ${b} = ${a * b}`;
...
// I believe it's the instance of joe

//
// 2. What is "this" when joe.scopeArrow() is invoked?

// My guess is that "this" is just including the student aspect.
//
// 3. Explain why "this" is different when an arrow function is used.
//
// Only guess is that it is almost identical to the other one above it but meant for => .
